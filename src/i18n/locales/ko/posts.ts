export const posts = {
  ...
  form: {
    ...
    addTag: '추가',
    tagAlreadyExists: '이미 추가된 태그입니다',
    publishImmediately: '게시물 공개 (체크 해제 시 임시저장)',
    saving: '저장 중...',
    updatePost: '게시물 수정',
    createPost: '게시물 작성',
  },
  ...
  edit: {
    title: '게시물 수정',
    loading: '게시물 로딩 중...',
    notAuthorized: '이 게시물을 수정할 권한이 없습니다',
    fetchError: '게시물을 불러올 수 없습니다',
  ...
  detail: {
    ...
    delete: '삭제',
    deleting: '삭제 중...',
    confirmDelete: '게시물 삭제',
    confirmDeleteMessage: '정말로 이 게시물을 삭제하시겠습니까? 이 작업은 되돌릴 수 없습니다.',
    deleted: '게시물이 삭제되었습니다',
    deleteError: '게시물 삭제 실패',
    commentAdded: '댓글이 추가되었습니다',
    commentError: '댓글 추가 실패',
    fetchError: '게시물을 불러올 수 없습니다',
  },
  categories: {
    technology: '기술',
