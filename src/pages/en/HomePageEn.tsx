        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 mb-6 whitespace-pre-line">
              Practice automated testing on real-world application scenarios including e-commerce, banking, social media, and booking systems.{'\n'}Perfect for Playwright, Cypress, and Selenium testing.
            </p>
            {isAuthenticated ? (
              <Link
                to="/qa"
              ...
              >
                Access QA Testing Playground
              </Link>
            ) : (
              <div>
                <p className="text-yellow-400 font-semibold mb-4">
                  🔒 Login required to access QA Testing Playground
                </p>
                <div className="flex gap-4 justify-center">
                  <Link
                    to="/login"
      ...
      <section className="container mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Interactive Tutorials</h3>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Test Automation</h3>
            <p className="text-gray-600 dark:text-gray-400">
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Progress Tracking</h3>
            <p className="text-gray-600 dark:text-gray-400">
