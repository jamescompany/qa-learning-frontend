            ...
            <div className="flex gap-4 justify-center">
              {isAuthenticated ? (
                ...
                <>
                  ...
                  <Link
                    to="/signup"
                    className="px-6 py-2.5 bg-white text-blue-600 border-2 border-blue-600 rounded-lg font-semibold hover:bg-blue-50 transition-colors"
                  >
                    회원가입
                  </Link>
                </>
      ...
      <section className="container mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <h3 className="text-xl font-semibold mb-2">대화형 튜토리얼</h3>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <h3 className="text-xl font-semibold mb-2">테스트 자동화</h3>
            <p className="text-gray-600">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <h3 className="text-xl font-semibold mb-2">진행 상황 추적</h3>
            <p className="text-gray-600">
