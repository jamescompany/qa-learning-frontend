    ...
    <div className="min-h-screen bg-gray-100">
        ...
        <div className="max-w-6xl mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              <button className="relative p-2 text-gray-600 hover:bg-gray-100 rounded-full" data-testid="home-btn">
                <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                </svg>
              </button>
              <button className="relative p-2 text-gray-600 hover:bg-gray-100 rounded-full" data-testid="explore-btn">
                <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 20l4-16m2 16l4-16M6 9h14M4 15h14" />
                </svg>
              </button>
              <button className="relative p-2 text-gray-600 hover:bg-gray-100 rounded-full" data-testid="notifications-btn">
                <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" />
                </svg>
                <span className="absolute top-1 right-1 block h-2 w-2 rounded-full bg-red-500"></span>
              </button>
              <button className="relative p-2 text-gray-600 hover:bg-gray-100 rounded-full" data-testid="messages-btn">
                <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white rounded-lg shadow p-4">
              ...
              <div className="space-y-2">
                {trendingTopics.map((topic, index) => (
                  <div key={index} className="flex justify-between items-center hover:bg-gray-50 p-2 rounded cursor-pointer" data-testid={`trending-${index}`}>
          ...
          <div className="lg:col-span-2">
              ...
              <div className="flex space-x-4 overflow-x-auto">
                {stories.map((story) => (
                  <div key={story.id} className="flex-shrink-0 text-center cursor-pointer" data-testid={`story-${story.id}`}>
                    <div className={`w-16 h-16 rounded-full p-0.5 ${story.hasNewStory ? 'bg-gradient-to-tr from-yellow-400 to-pink-600' : 'bg-gray-300'}`}>
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center justify-between mt-3">
                    <div className="flex space-x-2">
                      <button className="p-2 text-gray-600 hover:bg-gray-100 rounded-lg" data-testid="add-photo-btn">
                        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                        </svg>
                      </button>
                      <button className="p-2 text-gray-600 hover:bg-gray-100 rounded-lg" data-testid="add-video-btn">
                        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
                        </svg>
                      </button>
                      <button className="p-2 text-gray-600 hover:bg-gray-100 rounded-lg" data-testid="add-emoji-btn">
                        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14.828 14.828a4 4 0 01-5.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                      </button>
                      <button className="p-2 text-gray-600 hover:bg-gray-100 rounded-lg" data-testid="add-poll-btn">
                        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="space-y-4">
              {posts.map((post) => (
                <div key={post.id} className="bg-white rounded-lg shadow" data-testid={`post-${post.id}`}>
                  <div className="p-4">
                    {/* Post Header */}
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <button className="p-2 text-gray-600 hover:bg-gray-100 rounded-full" data-testid={`post-menu-${post.id}`}>
                        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div className="flex items-center justify-between border-t pt-2">
                      <button
                        ...
                        className={`flex items-center space-x-2 p-2 rounded-lg hover:bg-gray-100 ${post.isLiked ? 'text-red-600' : 'text-gray-600'}`}
                      ...
                      <button
                        ...
                        className="flex items-center space-x-2 p-2 text-gray-600 rounded-lg hover:bg-gray-100"
                      ...
                      <button
                        ...
                        className={`flex items-center space-x-2 p-2 rounded-lg hover:bg-gray-100 ${post.isBookmarked ? 'text-blue-600' : 'text-gray-600'}`}
            ...
            <div className="mt-6 text-center">
              <button className="px-6 py-2 bg-white border border-gray-300 rounded-lg hover:bg-gray-50" data-testid="load-more-btn">
                Load More Posts
              </button>
            </div>
          </div>
      ...
      {showCommentModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 max-w-md w-full" data-testid="comment-modal">
      ...
      {showShareModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 max-w-md w-full" data-testid="share-modal">
            ...
            <div className="grid grid-cols-4 gap-2 mb-4">
              <button className="p-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700" data-testid="share-facebook">
                Facebook
              </button>
              <button className="p-3 bg-blue-400 text-white rounded-lg hover:bg-blue-500" data-testid="share-twitter">
                Twitter
              </button>
              <button className="p-3 bg-green-600 text-white rounded-lg hover:bg-green-700" data-testid="share-whatsapp">
                WhatsApp
              </button>
              <button className="p-3 bg-gray-600 text-white rounded-lg hover:bg-gray-700" data-testid="share-copy-link">
                Copy Link
              </button>
            </div>
